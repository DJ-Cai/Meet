...
//                loadContact();
//                //查询我们的PrivateSet
//                BmobManager.getmInstance().queryPrivateSet(new FindListener<PrivateSet>() {
//                    @Override
...
//
//        if (CommonUtils.isNotEmpty(privateSets)) {
...
//                }
//                LogUtils.i("load...");
//                BmobManager.getmInstance().queryPhoneUser(entry.getValue(), new FindListener<IMUser>() {
//                    @Override
